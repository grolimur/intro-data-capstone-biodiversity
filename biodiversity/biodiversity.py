...
ax.set_xticks(range(len(conservation_status)))
...
category_pivot.columns = ['category', 'not_protected', 'protected'] # copied from biodiversity-solutions.ipynb
...
# - Is the data numerical or categorical? **RG: categorical**
# - How many pieces of data are you comparing? **RG: 7 pieces of data (species) in one dataset**
# 
# **categorial & more than 2 datatsets = > chi square test**
...
# **pval = 0.68759480966613362 => NOT SIGNIFICANT**
...
# **pval = 0.038355590229698977 => SIGNIFICANT**
...
bryce_duration = sample_size_per_variant / 250
print(bryce_duration)


# In[135]:


yellowstone_duration = sample_size_per_variant / 507
print(yellowstone_duration)
